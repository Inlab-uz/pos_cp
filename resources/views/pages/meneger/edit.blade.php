            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('menegerIndex') }}">@lang('cruds.user.title')</a>
                        </li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('menegerUpdate',$meneger->id) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label>@lang('cruds.user.fields.name')</label>
                                <input type="text" name="name"
                                       class="form-control {{ $errors->has('name') ? "is-invalid":"" }}"
                                       value="{{ old('name',$meneger->name) }}" required>
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email"
                                       ...
                                       value="{{ old('email',$meneger->email) }}" required>
                                @if($errors->has('email'))
