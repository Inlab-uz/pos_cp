            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                   id="title"
                                   placeholder="Coca-Cola" value="{{ old('title') }}">
                            @error('title')
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="10"
                                      ...
                                      id="description"
                                      placeholder="Coca-Cola 1.5l. Enjoy with drinking with meals">{{ old('description') }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                    ...
                    <strong>{{ $message }}</strong>
                            ...
                            <br>
                            <br>
                            <img class="align-items-center" id="blah" src="{{asset('consImages/image.png')}}" alt="your image" height="190px"
                                 width="240px"/>
                        </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror"
                                   id="price"
                                   placeholder="@lang('cruds.import.fields.price')" value="{{ old('price') }}">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                ...
                <button class="btn btn-primary" style="float: right" type="submit">@lang('global.create')</button>
            </form>
        </div>
    </div>
@endsection
